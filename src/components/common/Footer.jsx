                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><a href="#" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">Features</a></li>
                            <li><a href="#" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">Integrations</a></li>
                            <li><a href="#" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">Pricing</a></li>
                            <li><a href="#" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">Changelog</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><a href="#" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">About Us</a></li>
                            <li><a href="#" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">Careers</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><a href="#" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">Cookie Policy</a></li>
                        </ul>
                    </div>
                </div>
